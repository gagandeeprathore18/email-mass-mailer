        ...
        <div className="flex items-center space-x-12">
          ...
          <div className="flex items-center space-x-8">
            <button
              ...
              className={`py-2 text-sm font-semibold relative transition-colors cursor-pointer ${activeTab === 'dashboard' ? 'text-[#5038ED]' : 'text-slate-500 hover:text-slate-900'
                }`}
            >
              Dashboard
              {activeTab === 'dashboard' && (
            ...
            <button
              ...
              className={`py-2 text-sm font-semibold relative transition-colors cursor-pointer ${activeTab === 'campaigns' ? 'text-[#5038ED]' : 'text-slate-500 hover:text-slate-900'
                }`}
            >
              Campaigns
              {activeTab === 'campaigns' && (
              ...
              <div>
                ...
                <div className="flex items-baseline mt-2">
                  ...
                  {!loadingStats && stats?.summary && (
                    <span className={`text-[11px] font-bold px-2 py-0.5 rounded-full ml-3 inline-flex items-center ${stats.summary.sentTrend.startsWith('-')
            ...
            <div className="bg-white border border-slate-200/60 rounded-2xl p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-baseline mt-2">
                  ...
                  <span className={`text-[11px] font-semibold px-2.5 py-0.5 rounded-full ml-3 ${stats?.summary && stats.summary.tunnelHealth === '100%'
                    ...
                    {paginatedCampaigns.map((camp) => (
                      <tr key={camp.id} className="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td className="py-4 px-6">
                          <span
                            className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase inline-block ${camp.status === 'completed'
                    ...
                    {loadingStats ? (
                      ...
                      stats.smtpTunnels.slice(0, 3).map((tunnel, idx) => (
                        <div key={idx} className="flex items-center justify-between p-3 bg-white/10 rounded-xl">
                          ...
                          <span className={`inline-flex items-center text-[10px] font-bold ${tunnel.status === 'Healthy'
                              ? 'text-emerald-300'
                              : tunnel.status === 'Idle'
                                ? 'text-slate-300'
                                : 'text-rose-300'
